...
export const storeMessages: Record<StoreLocale, Record<string, string>> = {
  fr: {
    ...
    'footer.tagline':
      'Votre partenaire en électroménager en Tunisie. Les meilleures marques aux meilleurs prix.',
    ...
    'footer.copyright': '© 2024 ElectroTunisie. Tous droits réservés.',
    ...
    'home.why.title': 'Pourquoi choisir ElectroTunisie ?',
  ...
  ar: {
    ...
    'footer.tagline': 'شريكك في الأجهزة المنزلية في تونس. أفضل الماركات بأفضل الأسعار.',
    ...
    'footer.about': 'من نحن',
    'footer.adminLogin': 'دخول لوحة الإدارة',
    ...
    'footer.copyright': '© 2024 ElectroTunisie. كل الحقوق محفوظة.',
    ...
    'home.why.title': 'لماذا ElectroTunisie؟',
