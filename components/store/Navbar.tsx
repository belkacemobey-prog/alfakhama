        ...
        <div className="flex items-center justify-between h-16">
          <Link href="/" className="flex items-center gap-2 flex-shrink-0">
            <div className="hidden sm:block">
              ...
              <span className="text-[20px] font-extrabold text-[var(--cyan)] tracking-tight">
                Tunisie
              </span>
            </div>
            <span className="sm:hidden text-[18px] font-extrabold">
              <span className="text-[var(--text-primary)]">E</span>
              <span className="text-[var(--cyan)]">T</span>
            </span>
          </Link>
        ...
        {isMenuOpen && (
          ...
          >
            <nav className="px-4 py-4 flex flex-col gap-2">
              ...
              <Link
                href="/admin/login"
                className="mt-2 flex items-center justify-center gap-2 px-4 py-3 text-sm font-semibold bg-[var(--cyan)] text-[var(--text-on-badge)] rounded-[10px] hover:bg-[#00A8B0] sm:hidden"
                onClick={() => setIsMenuOpen(false)}
              >
